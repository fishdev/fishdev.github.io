export const podcasts = [
  {
    name: 'Reply All',
    image:
      'https://res.cloudinary.com/gimlet-media/image/upload/c_scale,f_auto,q_auto:best,w_1000/dica7jm4jwcj4zvjufdx',
    url: 'https://gimletmedia.com/shows/reply-all',
  },
  {
    name: 'Vergecast',
    image: 'https://podcasts.voxmedia.com/perch/resources/vergecast-1.jpg',
